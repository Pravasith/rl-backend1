  ...
  handler: async (request, h) => {
    ...
    const schema = Joi.object().keys({
      ...
      address: Joi.object().keys({
        ...
        detailedAddressLine2: Joi.string()
          .max(100)
          .allow(null),
      ...
      await Promise.all([
        ...
        .then(result => {
          if (result) {
            ...
            dataToSendBack = {
              companyProfilePicture: dataToSendBack.companyProfilePicture,
              companyName: dataToSendBack.companyName,
              experience: dataToSendBack.experience,
              companyDescriptionLine1: dataToSendBack.companyDescriptionLine1,
              companyDescriptionLine2: dataToSendBack.companyDescriptionLine2,
