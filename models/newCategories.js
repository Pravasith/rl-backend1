...
const BarrierFreeProducts = mongoose.model(
...
const ConstructionSiteEquipmentProducts = mongoose.model(
    "construction-site-equipment-product",
    NewCategorySchema
)
...
const ElectricalsProducts = mongoose.model(
    "electrical-product",
    NewCategorySchema
)
const ExternalWallsAndFacadesProducts = mongoose.model(
    "external-walls-and-facade-product",
    NewCategorySchema
)
const FencesAndPerimeterEnclosuresProducts = mongoose.model(
    "fences-and-perimeter-closure-product",
    NewCategorySchema
)
const FinishesProducts = mongoose.model("finishing-product", NewCategorySchema)
const FirePreventionAndSafetyProducts = mongoose.model(
    "fire-prevention-and-safety-product",
    NewCategorySchema
)
const FloorsAndWallInstallationsProducts = mongoose.model(
    "floors-and-wall-installation-product",
    NewCategorySchema
)
const FurnitureProducts = mongoose.model("furniture-product", NewCategorySchema)
const HardwareAndFastenersProducts = mongoose.model(
    "hardware-and-fastener-product",
    NewCategorySchema
)
const HeatingVentilationAndAirConditioningProducts = mongoose.model(
    "heating-ventilation-and-air-conditioning-product",
    NewCategorySchema
)
const HomeAutomationProducts = mongoose.model(
    "home-automation-product",
    NewCategorySchema
)
const InsulationProducts = mongoose.model(
    "insulation-product",
    NewCategorySchema
)
const KitchenProducts = mongoose.model("kitchen-product", NewCategorySchema)
const LiftsAndEscalatorsProducts = mongoose.model(
    "lifts-and-escalators-product",
    NewCategorySchema
)
...
const PartitionsProducts = mongoose.model(
    "partition-product",
    NewCategorySchema
)
const PlumbingProducts = mongoose.model("plumbing-product", NewCategorySchema)
const RenewableEnergySystemProducts = mongoose.model(
    "renewable-energy-systems-product",
    NewCategorySchema
)
const RoofProducts = mongoose.model("roofing-product", NewCategorySchema)
const SafetyAndSecurityProducts = mongoose.model(
    "safety-and-security-product",
    NewCategorySchema
)
const StairProducts = mongoose.model("stairs-product", NewCategorySchema)
const WaterproofingProducts = mongoose.model(
    "waterproofing-product",
    NewCategorySchema
)
const WaterSystemProducts = mongoose.model(
